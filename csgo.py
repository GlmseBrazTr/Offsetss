...
dwEntityList = (0x4DCDE5C)
dwForceAttack = (0x31FE370)
dwForceAttack2 = (0x31FE37C)
dwForceBackward = (0x31FE31C)
dwForceForward = (0x31FE3A0)
dwForceJump = (0x5277D80)
dwForceLeft = (0x31FE328)
dwForceRight = (0x31FE334)
dwGameDir = (0x62B880)
dwGameRulesProxy = (0x52EADDC)
dwGetAllClasses = (0xDDC17C)
dwGlobalVars = (0x58CCC8)
dwGlowObjectManager = (0x5316258)
dwInput = (0x521F430)
dwInterfaceLinkList = (0x964604)
dwLocalPlayer = (0xDB25DC)
dwMouseEnable = (0xDB82E8)
dwMouseEnablePtr = (0xDB82B8)
dwPlayerResource = (0x31FC6C0)
dwRadarBase = (0x5202BD4)
dwSensitivity = (0xDB8184)
dwSensitivityPtr = (0xDB8158)
dwSetClanTag = (0x8A340)
dwViewMatrix = (0x4DBF774)
dwWeaponTable = (0x521FEF8)
dwWeaponTableIndex = (0x326C)
dwYawPtr = (0xDB7F48)
dwZoomSensitivityRatioPtr = (0xDBE158)
dwbSendPackets = (0xD9542)
dwppDirect3DDevice9 = (0xA5050)
m_pStudioHdr = (0x2950)
m_yawClassPtr = (0xDB7F48)
m_pitchClassPtr = (0x5202E70)
interface_engine_cvar = (0x3E9EC)
convar_name_hash_table = (0x2F0F8)
m_bDormant = (0xED)
r_model_ambient_min = (0x59003C)
set_abs_angles = (0x1E52A0)
set_abs_origin = (0x1E50E0)
is_c4_owner = (0x3C85E0)
force_update_spectator_glow = (0x3BB53A)
anim_overlays = (0x2990)
m_flSpawnTime = (0x103C0)
find_hud_element = (0x54964F10)
