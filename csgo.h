...
constexpr ptrdiff_t dwEntityList = 0x4DCDE5C;
constexpr ptrdiff_t dwForceAttack = 0x31FE370;
constexpr ptrdiff_t dwForceAttack2 = 0x31FE37C;
constexpr ptrdiff_t dwForceBackward = 0x31FE31C;
constexpr ptrdiff_t dwForceForward = 0x31FE3A0;
constexpr ptrdiff_t dwForceJump = 0x5277D80;
constexpr ptrdiff_t dwForceLeft = 0x31FE328;
constexpr ptrdiff_t dwForceRight = 0x31FE334;
constexpr ptrdiff_t dwGameDir = 0x62B880;
constexpr ptrdiff_t dwGameRulesProxy = 0x52EADDC;
constexpr ptrdiff_t dwGetAllClasses = 0xDDC17C;
constexpr ptrdiff_t dwGlobalVars = 0x58CCC8;
constexpr ptrdiff_t dwGlowObjectManager = 0x5316258;
constexpr ptrdiff_t dwInput = 0x521F430;
constexpr ptrdiff_t dwInterfaceLinkList = 0x964604;
constexpr ptrdiff_t dwLocalPlayer = 0xDB25DC;
constexpr ptrdiff_t dwMouseEnable = 0xDB82E8;
constexpr ptrdiff_t dwMouseEnablePtr = 0xDB82B8;
constexpr ptrdiff_t dwPlayerResource = 0x31FC6C0;
constexpr ptrdiff_t dwRadarBase = 0x5202BD4;
constexpr ptrdiff_t dwSensitivity = 0xDB8184;
constexpr ptrdiff_t dwSensitivityPtr = 0xDB8158;
constexpr ptrdiff_t dwSetClanTag = 0x8A340;
constexpr ptrdiff_t dwViewMatrix = 0x4DBF774;
constexpr ptrdiff_t dwWeaponTable = 0x521FEF8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
constexpr ptrdiff_t dwYawPtr = 0xDB7F48;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDBE158;
...
constexpr ptrdiff_t m_yawClassPtr = 0xDB7F48;
constexpr ptrdiff_t m_pitchClassPtr = 0x5202E70;
...
constexpr ptrdiff_t set_abs_angles = 0x1E52A0;
constexpr ptrdiff_t set_abs_origin = 0x1E50E0;
constexpr ptrdiff_t is_c4_owner = 0x3C85E0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3BB53A;
constexpr ptrdiff_t anim_overlays = 0x2990;
constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
constexpr ptrdiff_t find_hud_element = 0x54964F10;
