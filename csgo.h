...
constexpr ptrdiff_t dwEntityList = 0x4DCEEAC;
constexpr ptrdiff_t dwForceAttack = 0x31FF3C0;
constexpr ptrdiff_t dwForceAttack2 = 0x31FF3CC;
constexpr ptrdiff_t dwForceBackward = 0x31FF36C;
constexpr ptrdiff_t dwForceForward = 0x31FF3F0;
constexpr ptrdiff_t dwForceJump = 0x5278DDC;
constexpr ptrdiff_t dwForceLeft = 0x31FF378;
constexpr ptrdiff_t dwForceRight = 0x31FF384;
constexpr ptrdiff_t dwGameDir = 0x62B880;
constexpr ptrdiff_t dwGameRulesProxy = 0x52EBE3C;
constexpr ptrdiff_t dwGetAllClasses = 0xDDD1D4;
constexpr ptrdiff_t dwGlobalVars = 0x58CCC8;
constexpr ptrdiff_t dwGlowObjectManager = 0x5317308;
constexpr ptrdiff_t dwInput = 0x5220480;
constexpr ptrdiff_t dwInterfaceLinkList = 0x965464;
constexpr ptrdiff_t dwLocalPlayer = 0xDB35DC;
constexpr ptrdiff_t dwMouseEnable = 0xDB92E8;
constexpr ptrdiff_t dwMouseEnablePtr = 0xDB92B8;
constexpr ptrdiff_t dwPlayerResource = 0x31FD710;
constexpr ptrdiff_t dwRadarBase = 0x5203C24;
constexpr ptrdiff_t dwSensitivity = 0xDB9184;
constexpr ptrdiff_t dwSensitivityPtr = 0xDB9158;
constexpr ptrdiff_t dwSetClanTag = 0x8A320;
constexpr ptrdiff_t dwViewMatrix = 0x4DC07C4;
constexpr ptrdiff_t dwWeaponTable = 0x5220F48;
...
constexpr ptrdiff_t m_pitchClassPtr = 0x5203EC0;
...
constexpr ptrdiff_t find_hud_element = 0x544F50F0;
